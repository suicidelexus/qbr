...
## 3. Динамика показателей (если есть даты)
Тренд по периодам: бюджет, показы, клики. Выделить периоды с лучшими результатами.
Показать общий рост или стабильность — только позитивная динамика.
